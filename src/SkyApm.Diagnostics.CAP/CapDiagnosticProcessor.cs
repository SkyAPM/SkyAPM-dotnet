...
public class CapTracingDiagnosticProcessor : ITracingDiagnosticProcessor
{
    ...
    public void BeforePublishStore([Object] CapEventDataPubStore eventData)
    {
        ...
        _ = context.Span.AddTag(Tags.DB_TYPE, "Sql");
    ...
    public void BeforePublish([Object] CapEventDataPubSend eventData)
    {
        ...
        _ = context.Span.AddTag(Tags.MQ_TOPIC, eventData.Operation);
        _ = context.Span.AddTag(Tags.MQ_BROKER, eventData.BrokerAddress.Endpoint);
    ...
    public void AfterPublish([Object] CapEventDataPubSend eventData)
    {
        ...
        _ = _contexts.TryRemove(eventData.TransportMessage.GetId(), out _);
    }
    ...
    public void CapAfterSubscriberInvoke([Object] CapEventDataSubExecute eventData)
    {
        ...
        _ = _contexts.TryRemove(eventData.Message.GetId() + eventData.Message.GetGroup(), out _);
    }
    ...
    private static StringOrIntValue GetComponent(BrokerAddress address, bool isPub)
    {
        if (isPub)
        {
            switch (address.Name)
