...
public struct StringOrNumValue<T> : IEquatable<StringOrNumValue<T>> where T : struct
{
    ...
    {
        return HasNumValue ? _numValue.ToString() : _stringValue;
    }
    ...
    public static implicit operator StringOrNumValue<T>(string value) => new(value);
    public static implicit operator StringOrNumValue<T>(T value) => new(value);
