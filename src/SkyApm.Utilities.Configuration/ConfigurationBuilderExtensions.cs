    ...
    internal static class ConfigurationBuilderExtensions
    {
        public static IConfigurationBuilder AddSkyWalkingDefaultConfig(this IConfigurationBuilder builder, IConfiguration configuration)
        {
            ...
            var defaultConfig = new Dictionary<string, string>
            {
                ...
                { "SkyWalking:Transport:QueueSize", configuration?.GetSection("SkyWalking:Transport:QueueSize").Value ?? "80000" },
                { "SkyWalking:Transport:Interval", configuration?.GetSection("SkyWalking:Transport:Interval").Value ?? "2000" },
                { "SkyWalking:Transport:BatchSize", configuration?.GetSection("SkyWalking:Transport:BatchSize").Value ?? "2000" },
                { "SkyWalking:Transport:Parallel", configuration?.GetSection("SkyWalking:Transport:Parallel").Value ?? "10" },
                { "SkyWalking:Transport:Pause", configuration?.GetSection("SkyWalking:Transport:Pause").Value ?? "500" },
