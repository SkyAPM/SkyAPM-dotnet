    ...
    internal static class SegmentV6Helpers
    {
        public static UpstreamSegment Map(SegmentRequest request)
        {
            ...
            var traceSegment = new SegmentObject
            {
                ...
                ServiceId = request.Segment.ServiceId.GetIntValue(),
                ServiceInstanceId = request.Segment.ServiceInstanceId.GetIntValue(),
                IsSizeLimited = false
            };
        ...
        private static SegmentReference MapToSegmentReference(SegmentReferenceRequest referenceRequest)
        {
            ...
            {
                ParentServiceInstanceId = referenceRequest.ParentServiceInstanceId.GetIntValue(),
                EntryServiceInstanceId = referenceRequest.EntryServiceInstanceId.GetIntValue(),
