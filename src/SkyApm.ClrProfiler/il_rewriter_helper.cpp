...
ILRewriter* ILRewriterHelper::GetILRewriter() const
{
	return m_ILRewriter;
}

void ILRewriterHelper::SetILPosition(ILInstr* pILInstr) 
{
	m_ILInstr = pILInstr;
}

void ILRewriterHelper::Pop() const 
{
...
void ILRewriterHelper::LoadNull() const 
{
	ILInstr* pNewInstr = m_ILRewriter->NewILInstr();
...
void ILRewriterHelper::LoadStr(mdToken token) const
{
	ILInstr* pNewInstr = m_ILRewriter->NewILInstr();
...
void ILRewriterHelper::LoadInt64(const INT64 value) const 
{
	ILInstr* pNewInstr = m_ILRewriter->NewILInstr();
...
void ILRewriterHelper::LoadInt32(const INT32 value) const 
{
...
void ILRewriterHelper::LoadArgument(const UINT16 index) const
{
	static const std::vector<OPCODE> opcodes = {
		CEE_LDARG_0,
		CEE_LDARG_1,
...
void ILRewriterHelper::LoadIND(unsigned elementType) const
{
	unsigned op_code = 0;
	switch (elementType)
	{
...
void ILRewriterHelper::LoadToken(mdToken token) const
{
	ILInstr* pNewInstr = m_ILRewriter->NewILInstr();
...
void ILRewriterHelper::StLocal(unsigned index) const
{
	static const std::vector<OPCODE> opcodes = {
		   CEE_STLOC_0,
		   CEE_STLOC_1,
...
void ILRewriterHelper::LoadLocal(unsigned index) const
{
	static const std::vector<OPCODE> opcodes = {
			CEE_LDLOC_0,
			CEE_LDLOC_1,
...
void ILRewriterHelper::Cast(const mdTypeRef type_ref) const {
	ILInstr* pNewInstr = m_ILRewriter->NewILInstr();
...
void ILRewriterHelper::Box(const mdTypeRef type_ref) const {
	ILInstr* pNewInstr = m_ILRewriter->NewILInstr();
...
void ILRewriterHelper::UnboxAny(const mdTypeRef type_ref) const {
	ILInstr* pNewInstr = m_ILRewriter->NewILInstr();
...
void ILRewriterHelper::CreateArray(const mdTypeRef type_ref,
...
void ILRewriterHelper::CallMember(const mdMemberRef& member_ref,
...
void ILRewriterHelper::Duplicate() const {
	ILInstr* pNewInstr = m_ILRewriter->NewILInstr();
	pNewInstr->m_opcode = CEE_DUP;
	m_ILRewriter->InsertBefore(m_ILInstr, pNewInstr);
}

void ILRewriterHelper::BeginLoadValueIntoArray(const INT32 arrayIndex) const {
...
void ILRewriterHelper::EndLoadValueIntoArray() const {
...
void ILRewriterHelper::Return() const {
	ILInstr* pNewInstr = m_ILRewriter->NewILInstr();
	pNewInstr->m_opcode = CEE_RET;
	m_ILRewriter->InsertBefore(m_ILInstr, pNewInstr);
}

ILInstr* ILRewriterHelper::Rethrow() const
{
	ILInstr* pNewInstr = m_ILRewriter->NewILInstr();
...
ILInstr* ILRewriterHelper::EndFinally() const
{
	ILInstr* pNewInstr = m_ILRewriter->NewILInstr();
...
ILInstr* ILRewriterHelper::CallMember0(const mdMemberRef& member_ref, bool is_virtual) const
{
	ILInstr* pNewInstr = m_ILRewriter->NewILInstr();
	pNewInstr->m_opcode = is_virtual ? CEE_CALLVIRT : CEE_CALL;
	pNewInstr->m_Arg32 = member_ref;
