...
dotnet $WorkDir/ILRepack.Runner/ILRepack.Runner.exe/ILRepack.Runner.dll /keyfile:$WorkDir/skyapm.snk /ver:$BuildVersion /copyattrs /xmldocs /ndebug /internalize /out:$OUTDLL $DLLS
